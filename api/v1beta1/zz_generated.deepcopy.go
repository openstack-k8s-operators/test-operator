...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkflowExternalPluginType) DeepCopyInto(out *WorkflowExternalPluginType) {
	*out = *in
	...
	if in.ChangeRepository != nil {
		in, out := &in.ChangeRepository, &out.ChangeRepository
		*out = new(string)
		**out = **in
	}
	if in.ChangeRefspec != nil {
		in, out := &in.ChangeRefspec, &out.ChangeRefspec
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkflowExternalPluginType.
func (in *WorkflowExternalPluginType) DeepCopy() *WorkflowExternalPluginType {
	if in == nil {
		return nil
	}
	out := new(WorkflowExternalPluginType)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkflowTempestRunSpec) DeepCopyInto(out *WorkflowTempestRunSpec) {
	*out = *in
	...
	if in.ExternalPlugin != nil {
		in, out := &in.ExternalPlugin, &out.ExternalPlugin
		*out = make([]WorkflowExternalPluginType, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
