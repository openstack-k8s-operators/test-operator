...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContinuousTestingSpec) DeepCopyInto(out *ContinuousTestingSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContinuousTestingSpec.
func (in *ContinuousTestingSpec) DeepCopy() *ContinuousTestingSpec {
	if in == nil {
		return nil
	}
	out := new(ContinuousTestingSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TempestSpec) DeepCopyInto(out *TempestSpec) {
	*out = *in
	out.ContinuousTestingSpec = in.ContinuousTestingSpec
