...
func GetVolumes(
	...
	for _, vol := range instance.Spec.ExtraMounts {
...
// GetVolumeMounts -
func GetVolumeMounts(mountCerts bool, instance *testv1beta1.AnsibleTests, externalWorkflowCounter int) []corev1.VolumeMount {
