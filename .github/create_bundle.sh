...
CLUSTER_BUNDLE_FILE="bundle/manifests/test-operator.clusterserviceversion.yaml"
...
# Output:
# Calculating image digest for docker://quay.io/openstack-k8s-operators/test-operator:d03f2c1c362c04fc5ef819f92a218f9ea59bbd0c
