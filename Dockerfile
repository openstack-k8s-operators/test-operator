...
ARG IMAGE_COMPONENT="test-operator-container"
ARG IMAGE_NAME="test-operator"
ARG IMAGE_VERSION="1.0.0"
ARG IMAGE_SUMMARY="Test Operator"
ARG IMAGE_DESC="This image includes the OpenStack test-operator"
