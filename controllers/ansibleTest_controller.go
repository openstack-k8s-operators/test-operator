...
import (
	...
	"github.com/openstack-k8s-operators/test-operator/pkg/ansibleTests"
...
type AnsibleTestsReconciler struct {
	Reconciler
}
...
// Reconcile - AnsibleTestsReconciler
func (r *AnsibleTestsReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	...
	serviceLabels := map[string]string{
		common.AppSelector: ansibleTests.ServiceName,
...
func (r *AnsibleTestsReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&testv1beta1.AnsibleTests{}).
		Owns(&batchv1.Job{}).
		Owns(&corev1.Secret{}).
...
func (r *Reconciler) OverwriteAnsibleWithWorkflow(
	ctx context.Context,
	instance v1beta1.AnsibleTestsSpec,
	sectionName string,
