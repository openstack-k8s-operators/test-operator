...
var (
	...
	// ErrFieldNotFound is the error message for encountering invalid reflect field
	ErrFieldNotFound = errors.New("field not found: reflect error")
)
...
func GetPodName(instance interface{}, stepNum int) string {
	v := reflect.ValueOf(instance)
